...
function OSMMapWithAutocomplete() {
  ...
  return (
    <div className="relative w-full h-screen mx-auto p-4 min-h-screen flex">
      {/* Left panel: hidden until a marker exists */}
      {hasMarker && (
        <div className="w-[44%] mx-2 h-screen rounded-lg bg-transparent">
      ...
      <div
        className={`relative ${
          hasMarker ? "w-[56%] max-w-7xl mx-auto" : "w-full"
        } flex flex-col bg-green-400 min-h-screen transition-all duration-300`}
      >
        {/* Map Container */}
        <MapContainer
        ...
        <div className="absolute top-2 md:top-2 lg:top-2 right-2 md:right-2 lg:right-2 z-[1000] w-[calc(100%-3rem)] sm:w-96 md:w-[420px]">
